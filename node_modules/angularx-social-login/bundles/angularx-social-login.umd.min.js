(function (global, factory) {
    ...
    (global = global || self, factory(global.angularxSocialLogin = {}, global.ng.core));
    ...
    function getLocaleNumberSymbol(locale, symbol) {
        ...
        if (typeof res === 'undefined') {
            if (symbol === NumberSymbol.CurrencyDecimal) {
                return data[core.ɵLocaleDataIndex.NumberSymbols][NumberSymbol.Decimal];
            }
            else if (symbol === NumberSymbol.CurrencyGroup) {
                return data[core.ɵLocaleDataIndex.NumberSymbols][NumberSymbol.Group];
            }
        }
        return res;
    }
